...
def generate_art(collection: str, name: str):
    ...
    output_dir = os.path.join("C:/Users/justy/OneDrive/Pulpit/nft project", collection)
    ...
    image = image.resize((image_size_px // rescale, image_size_px // rescale), resample=Image.LANCZOS)
